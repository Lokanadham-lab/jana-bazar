...
## GitHub root-folder compatibility
This V9.1 build intentionally keeps all logo/image assets in the repository root because the current GitHub repository screenshot shows the assets at root level (not inside an `assets/` folder). All HTML, JS and manifest paths have been corrected accordingly.
